  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      <h1 className="text-xl font-semibold">
        {type === "create" ? "انشاء اعلان جديد" : "تحديث الاعلان"}
      </h1>

      <div className="flex justify-between flex-wrap gap-4">
        {type === "update" && <input type="hidden" {...register("id")} />}
        
        <InputField label="عنوان الاعلان" name="title" register={register} error={errors?.title} />
        ...
        <div className="w-full flex items-center gap-2">
            ...
            />
            <label htmlFor="isPinned" className="text-sm font-medium text-gray-700">تثبيت هذا الإعلان في الأعلى</label>
        </div>
      </div>
