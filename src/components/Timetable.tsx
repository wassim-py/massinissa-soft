                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap items-center justify-between text-xs text-gray-600 pt-1.5 border-t border-gray-200/60 font-medium gap-2">
                      ...
                      <span className="text-gray-700 font-semibold bg-gray-100 px-1.5 py-0.5 rounded text-[11px]">
                          ...
                          >
                            <div>
                                ...
                                <div className="flex flex-col mt-2 gap-0.5">
                                    ...
                                    <span className="text-[10px] text-gray-700 font-medium bg-white/80 border border-gray-200/80 px-1 py-0.5 rounded inline-flex items-center gap-0.5 w-fit">
                                      🏢 {lesson.branchName || t("unspecified")}
                                    </span>
